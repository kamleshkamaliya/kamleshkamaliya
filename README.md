...
* **HubSpot CMS:** Crafting bespoke, easy-to-manage themes and websites.
* **Shopify E-commerce:** Building unique, high-converting stores from Figma/Sketch designs.

I'm passionate about writing ✨ **clean, efficient, and high-quality code** ✨ that prioritizes speed, performance, and a great user experience.

---

### 🥇 My Credentials & Specializations

I'm proud to be certified and have my work recognized by the community:

* 🏆 **Winner of the HubSpot Themes Challenge**
* **HubSpot Certified:**
    * [HubSpot CMS for Developers II: Best Practices](https://app.hubspot.com/academy/achievements/8pnzx2h0/en/1/kamlesh-kamaliya/hubspot-cms-for-developers-ii-best-practices)
    * [HubSpot CMS for Developers](https://app.hubspot.com/academy/achievements/s9x8lxz4/en/1/kamlesh-kamaliya/hubspot-cms-for-developers)
    * [SEO Certified](https://app.hubspot.com/academy/achievements/cn62p76h/en/1/kamlesh-kamaliya/seo)
...
* Building custom themes from designs (Figma/Sketch to **Liquid**)
* Shopify API Integrations (connecting CRMs, ERPs, etc.)
* Shopify Plus Customizations (including Shopify Scripts)
* Performance Optimization & Core Web Vitals
* B2B (Wholesale) & B2C Site Development
